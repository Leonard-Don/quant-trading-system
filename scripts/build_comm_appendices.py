...
APPENDIX_A_TRANSLATION_PARAGRAPHS = [
    ...
    (
        "在第一章导论部分，报告进一步把人工智能、机器学习和大数据的关系说明得更充分。其核心意思是："
    ...
    (
        ...
        "客户服务、生物识别认证、交易策略执行和个性化产品推荐；中后台则可能将其用于反洗钱、客户尽职调查（KYC）、"
    ...
    (
        ...
        "风险管理部门以及监管者适度解释，就难以在授信、投资组合管理、交易执行等关键流程中建立清晰的问责链条。"
    ...
    (
        ...
        "必须同步强化数据治理、模型验证、内部责任划分和外部监管沟通。对行业参与者而言，关键并不是简单地“引入模型”，"
...
APPENDIX_B_SECTIONS = {
    ...
    "二、课题的作用与思考": [
        ...
        (
            ...
            "促使使用者只关注榜单排序而忽视风险教育。再从可持续发展角度看，持续抓取、缓存和计算金融数据虽然不属于"
    ...
    "三、课题的建议与构想": [
        (
            ...
            "代理变量或补充源得到的结果”。如果未来扩展到更多使用场景，还可以加入更明确的研究提示，例如提醒使用者"

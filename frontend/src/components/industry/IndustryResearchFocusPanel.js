        ...
        {selectedIndustry ? (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                >
                    ...
                    <div style={{ fontSize: 13, lineHeight: 1.7, color: TEXT_PRIMARY }}>{selectedIndustryFocusNarrative}</div>
                </div>
                ...
                {selectedIndustryScoreBreakdown.length > 0 && (
                    <div
                        style={{
                            padding: '10px 12px',
                            borderRadius: 10,
                    ...
                    >
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
                            {selectedIndustryScoreBreakdown.map((factor) => (
                                <div key={factor.key} style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                                    ...
                                    <Progress
                                        ...
                                        size="small"
                                    />
                                    <div style={{ fontSize: 11, lineHeight: 1.7, color: TEXT_SECONDARY }}>
                                        {factor.summary}
                                    </div>
                                </div>
                            ))}

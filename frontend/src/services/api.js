...
export const API_TIMEOUT_PROFILES = {
  ...
  // order of 30-90s (e.g. cross-market / walk-forward backtests run many
  // overlapping windows back-to-back); we add headroom so a cold cache /
  // heavier override doesn't trip the timeout.

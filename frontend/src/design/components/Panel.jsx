...
export default function Panel({ title, icon, actions, variant = 'flat', className, style, testId, children }) {
  const hasHeader = title || actions;
  return (
    <Surface variant={variant} className={cn('p-4', className)} style={style} data-testid={testId}>
      {hasHeader && (
